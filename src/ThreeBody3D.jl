...
export ThreeBodySystem,
       ...
       RegularizedSwitchingMode, AutomaticSwitchingThresholdPolicy,
       AbsoluteSwitchingThresholdPolicy, ScaleAwareSwitchingThresholdPolicy,
       automatic_switching_thresholds, AutomaticSwitchingParameters,
       AutomaticSwitchingProgressState, AutomaticSwitchingProgressEvidence,
       AutomaticSwitchingFailure, RegularizationSwitchEvent,
       PairObservables, pair_observables, pair_separations,
       pair_radial_rates, AutomaticSwitchingCompetitionEvidence,
